...
adb pull /sdcard/powerword/fail2.xml ./testreport/testresult_fail_nowifi2.xml
         */
        List<String> cmds = new ArrayList<String>();
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/AUTOTEST-ok.xml  testreport/"+serial+"/testresult_ok_wifi.xml");
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/ok2.xml  testreport/"+serial+"/testresult_ok_wifi2.xml");
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/fail2.xml  testreport/"+serial+"/testresult_fail_wifi2.xml");
        ...
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/tests_list.txt ./testreport/"+serial+"/wifion_2_tests_list.txt");
        cmds.add("adb -s "+ serial+" shell rm /sdcard/powerword/tests_list.txt");
        
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/tests_result_list.txt ./testreport/"+serial+"/wifion_2_tests_result_list.txt");
        cmds.add("adb -s "+ serial+" shell rm /sdcard/powerword/tests_result_list.txt");
        
        cmds.add("adb -s "+ serial+" pull /sdcard/powerword/tests_result_errors.txt ./testreport/"+serial+"/wifion_2_tests_result_errors.txt");
